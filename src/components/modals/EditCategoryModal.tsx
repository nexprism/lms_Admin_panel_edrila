...
const EditCategoryModal: React.FC<EditCategoryModalProps> = ({
  ...
  const loadCategoryData = async () => {
    ...
    try {
      const result = await dispatch(fetchCourseCategoryById(categoryId)).unwrap();
      ...
      setCategoryImagePreview(categoryData.image ? `${import.meta.env.VITE_IMAGE_URL}/${categoryData.image}` : null);

      setCategoryForm({
        name: categoryData.name,
        slug: categoryData.slug,
        status: categoryData.status === "active" || categoryData.status === "inactive" ? categoryData.status : "active"
      });
      
      // Load subcategories - check both possible keys
      const subcategories = categoryData.subcategories || categoryData.subCategories || [];
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
      ...
      await dispatch(updateCourseCategory({
  ...
  const handleAddSubCategory = async () => {
    ...
    try {
      ...
      const result = await dispatch(createSubCategory(subCategoryData)).unwrap();
  ...
  const handleDeleteSubCategory = async () => {
    ...
    try {
      ...
      setSubCategories(prev => prev.filter(sub => sub._id !== deleteConfirmation.subCategoryId));
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => handleSubCategoryInputChange('slug', e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white"
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => handleSubCategoryInputChange('status', e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white"
                          >
                            <option value="active">Active</option>
                            <option value="inactive">Inactive</option>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => handleEditSubCategoryInputChange('name', e.target.value)}
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white"
                                  />
                                </div>
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => handleEditSubCategoryInputChange('slug', e.target.value)}
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white"
                                  />
                                </div>
                                <div>
                                  ...
                                  <select
                                    ...
                                    onChange={(e) => handleEditSubCategoryInputChange('status', e.target.value)}
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white"
                                  >
                                    <option value="active">Active</option>
                                    <option value="inactive">Inactive</option>
