  ...
  return (
    <div className={`relative ${isFullscreen ? 'fixed inset-0 z-50 bg-white' : ''} ${className}`}>
      <div className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-lg">
        {/* Toolbar */}
        <div className="border-b bg-gray-50 p-3 flex flex-wrap gap-2 items-center justify-between">
        ...
        {isPreview ? (
          <div
            className="p-6 prose max-w-none bg-gray-50 overflow-y-auto"
          ...
          <div
            ref={editorRef}
            className="p-6 outline-none prose max-w-none bg-white overflow-y-auto focus:ring-2 focus:ring-blue-500 focus:ring-inset"
            style={{ height: editorHeight }}
