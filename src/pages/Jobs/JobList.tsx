    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Jobs Management</h2>
          <Link
            to="/jobs/add"
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div key={job._id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              {job.thumbnail ? (
                <img
                  src={`${job.thumbnail}`}
                  alt={job.title}
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100">
                      {job.location.type === 'remote' ? 'Remote' : job.location.address?.street || 'On-site'}
                    </span>
                  </div>

                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-400">Experience:</span>
                    <span className="font-medium text-gray-900 dark:text-gray-100">{getExperienceLevelText(job.experienceLevel)}</span>
                  </div>
          ...
          <div className="text-center py-12">
            <div className="text-gray-500 dark:text-gray-400">
              <svg className="mx-auto h-12 w-12 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2m8 0V8a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V6m8 0H8" />
              </svg>
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No jobs found</h3>
              <p className="text-sm">Get started by creating your first job posting.</p>
            </div>
          </div>
        )}
      </div>
